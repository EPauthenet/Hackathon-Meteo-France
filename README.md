...
- Nombre de jours où la température moyenne est supérieure à 0 (Tmean > 0) par hiver, avec hiver={janvier, février, mars, avril} pour les données historique
- Moyenne, maximium et minimum du nombre de jours sur tous les hivers par plage de 20 ans autour des horizons de temps (2030, 2050, 2070, 2090) pour les données historiques 
- Différences entre valeurs calculées pour les données historiques (moyenne, maximum et minimum) et les valeurs calculées pour chaque horizons de temps des données de projection (moyenne, macimum, minimum) 
...
- Moyenne, maximium et minimum du nombre de jours sur toutes les années par plage de 20 ans autour des horizons de temps (2030, 2050, 2070, 2090) pour les données de projection
- Nombre de jours où la température minimale est supérieure à 0 (Tmin > 20) par hiver par année pour les données historique
- Moyenne, maximium et minimum du nombre de jours sur toutes les années par plage de 20 ans autour des horizons de temps (2030, 2050, 2070, 2090) pour les données historiques 
- Différences entre valeurs calculées pour les données historiques (moyenne, maximum et minimum) et les valeurs calculées pour chaque horizons de temps des données de projection (moyenne, macimum, minimum) 
...
- la prévision de fréquence de nuits tropicales
